...
public class CreateMandateTest extends BaseTest {
	...
	public void createMandate() {
		...
		abstractPageSteps.deleteElementIfExists("g20k");
		...
		abstractPageSteps.selectActionFromRibbon("Create");
		itemsPageSteps.inputKeyField("377");
		itemsPageSteps.inputCodeField("g20k");
		itemsPageSteps.inputTitleField("edit currency");
		itemsPageSteps.clickOnActiveCheckBox();
		abstractPageSteps.selectActionFromCreateAndEditPage("Save");
		 // create country
		 ...
		 abstractPageSteps.selectActionFromRibbon("Create");
		 itemsPageSteps.createRiskCriteria("899", "Edit Risk",
		 "B (Category B)");
		...
		mandatesPageSteps.checkMandateInformation("Process Agent",
				...
				"-50", "jd", "John Doe", "Dev", "599", "1.00", "g12k", "2.00",
				"g12k", "12.00", "Test", "2000", "2.00", "g12k", "Test", "Ro",
				"1", "g12k", "Test", "Part 1", "12", "g12k", "test", "12",
				"Just test", "1a5", "Estate 1", "1", "g12k", "test", "1a5",
				"78", "g12k", "Romania", "testing", "Test", "1b5", "comment",
				"233", "-50");
		// change type
		...
		abstractPageSteps.deleteElementIfExists("g20k");
		itemsPageSteps.checkThatElementIsNotPresent("g20k");
		abstractPageSteps.selectActionFromLeftMenu("Countries");
		abstractPageSteps.deleteElementIfExists("1b5");
